...
# Dep-free modules (the hzl/hzv skeletons) have no ./vendor and build the same way
# without -mod=vendor — still hermetic, since there is nothing to fetch.
ARG TARGETOS=linux
